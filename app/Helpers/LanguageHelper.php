...
if (! function_exists('activity_action_labels')) {
    ...
    function activity_action_labels(): array
    {
        return marketing_task_labels() + [
            ...
            'user.exported' => 'Exported users',
            'finance.refunds_exported' => 'Exported refunds',
            ...
            'category.deleted' => 'Deleted catalog niche',
            'analytics.exported' => 'Exported marketplace analytics',
