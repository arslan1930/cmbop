...
class AdminDashboardTest extends TestCase
{
    ...
    public function test_admin_dashboard_loads(): void
    {
        ...
        $this->actingAs($admin)
            ...
            ->assertSee(route('admin.dashboard.ops-health', absolute: false), false)
            ->assertSee(route('admin.dashboard.business', absolute: false), false)
            ...
            ->assertSee(route('admin.inbox.index', ['tab' => 'disputes']), false)
            ->assertSee('unpaid ·')
            ->assertSee('community ·')
            ->assertSee('disputes')
            ->assertSee(route('admin.inbox.index', ['tab' => 'community']), false)
            ->assertSee(route('admin.inbox.index'), false)
